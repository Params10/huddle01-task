...
export declare class EthSignRequest extends RegistryItem {
    ...
    static constructETHRequest(signData: Buffer, signDataType: DataType, hdPath: string, xfp: string, uuidString?: string, chainId?: number, address?: string): EthSignRequest;
}
export {};
